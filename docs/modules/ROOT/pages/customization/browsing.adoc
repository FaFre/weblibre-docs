...
Choose the option that matches how you scan your tabs. This setting also affects the horizontal order in the Quick Tab Switcher: with *First*, new tabs appear to the left; with *End*, to the right.

You can also set the overall **Tab Direction** to control whether tabs flow from top to bottom or from left to right, depending on your layout preference.

Find **New Tab Position** in **Settings > Browsing > New Tab Position**.
Find **Tab Direction** in **Settings > Browsing > Tab Direction**.
