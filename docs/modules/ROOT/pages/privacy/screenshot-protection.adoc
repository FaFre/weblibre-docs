...
Private tabs also block screenshots by default, even if browser-wide *Screenshot Protection* is off.
...
== Screenshots in Private Tabs

If you need to capture something in a private tab, turn on **Allow screenshots in private tabs** in **Settings > Privacy & Security**. This is off by default. It does not override browser-wide **Screenshot Protection**: if that setting is on, screenshots remain blocked throughout WebLibre.
