...
You can also save custom DoH resolvers alongside the built-in providers. WebLibre keeps up to 16, so you can switch providers without re-entering the URL each time.
...
. Optional: tap **Add Custom Resolver** and enter a resolver URL (and a name if you want), then select it

You can edit or delete a saved resolver. If you delete the one currently selected, WebLibre switches back to its default provider.
...
* Check a saved custom resolver's URL for typing mistakes
