...
WebLibre can also complete addresses inline as you type, using your history and the built-in popular sites list.
If you turn on **Settings > Search > Autocomplete on enter**, pressing enter accepts the current inline suggestion instead of searching for the literal text you typed.
