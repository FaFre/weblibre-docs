...
### Build
- Standard build: `npm exec antora -- generate antora-playbook.yml --clean && node prepare-site.js`
- Antora-only build: `npm exec antora -- generate antora-playbook.yml --clean`
- Default output directory: `build/site`
- More verbose logging: `npm exec antora -- generate antora-playbook.yml --clean --log-level info && node prepare-site.js`
...
- Did `npm exec antora -- generate antora-playbook.yml --clean && node prepare-site.js` succeed?
- Did you inspect the relevant generated page in `build/site/`?
